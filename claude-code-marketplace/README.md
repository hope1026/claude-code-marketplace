...
Claude Code marketplace package inside the `aiagent-plugins` monorepo.
Add this package directory to your projects and install plugins to extend Claude Code's capabilities.

## Adding the Marketplace

### From GitHub

If you publish this package as a standalone repo, use that repo URL here.
If you keep the monorepo layout, point Claude Code at the `claude-code-marketplace/` subdirectory instead of the monorepo root.

```shell
/plugin marketplace add ./path/to/aiagent-plugins/claude-code-marketplace
```
